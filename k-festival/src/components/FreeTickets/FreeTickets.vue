...
<template>
    <section class="col-12 section section-event">
        <div class="col-12" align="left">
            <h2 class="head-gibson main-head">TANGGAL</h2>
        </div>
        <div class="col-12 event-body">
            ...
            <div class="col-12 event-list-item row">
                ...
                <div class="col-5 col-md-7 event-thumb">
                ...
                <div class="col-5 col-md-4 event-item-caption">
                    <a href="#flying" title="FLYING">
                        <h3>FLYING</h3>
                    </a>
                    ...
                    <a href="https://www.ilotte.com/ev/flying-ticket-giveaway/000002302/view.do" title="FLYING" class="view-button registration" >
                        APPLY
                    </a>
                </div>
            </div>
            ...
            <div class="col-12 event-list-item row">
                ...
                <div class="col-5 col-md-4 event-item-caption">
                    ...
                    <a href="https://www.ilotte.com/ev/korean-culture-brand-festival-ticket-giveaway/000002304/view.do" title="Korea Culture Brand Festival" class="view-button registration" >
                        APPLY
                    </a>
                </div>
            </div>
