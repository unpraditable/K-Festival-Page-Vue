...
<template>
    <section class="col-12 section passport-page">
        <div class="col-sm-10 offset-1">
            ...
            <section class="col-12 header-section">
                <div class="row">
                    <div class="col-12">
            ...
            <section id="passport-to-korea" class="col-12 passport-content-section">
                <div class="row">
                    <div class="col-12 passport-content-header">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 passport-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <img src="https://ecm-prd-pub.s3.ap-southeast-1.amazonaws.com/kfestival/assets/img/logo_footer_kpassport.jpg" class="img-fluid" alt="Partners of K-Festival">
                    </div>
                </div>
            ...
            <section id="temukan-mimpimu" class="col-12 passport-content-section">
                <div class="row">
                    <div class="col-12 passport-content-header">
                        <h4>PASSPORT TO KOREA</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <img src="https://ecm-prd-pub.s3.ap-southeast-1.amazonaws.com/kfestival/assets/img/%5BPoster%5DMake%20your%20dream%20come%20true%402x.png" class="img-fluid" alt="Make Your Dream Come True Poster">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2"></div>
                    <div class="col-sm-10 passport-body">
                        ...
                        <div class="btn-ext-link-wrapper">
                            <a class="btn-ext-link" href="http://id.korean-culture.org" >Go To Official Website <i class="glyphicon glyphicon-chevron-right"></i></a>

                        </div>
                        <div class="sns-wrapper">
                            <a href="https://www.instagram.com/kcc.id"  title="KCC Indonesia Instagram" class="sns">
            ...
            <section id="sns-competition" class="col-12 passport-content-section">
                <div class="row">
                    <div class="col-12 passport-content-header">
                        <h4>SNS Promo</h4>
                ...
                <div class="row">
                    <div class="col-12">
                        <img src="https://ecm-prd-pub.s3.ap-southeast-1.amazonaws.com/kfestival/assets/img/sns.jpeg" class="img-fluid center" alt="SNS Hashtag Event">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-2"></div>
